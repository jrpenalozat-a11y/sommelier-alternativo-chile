      ...
      .then((txt) => {
        ...
        regiones.forEach((reg) => {
          (reg.valles || []).forEach((valle) => {
            ...
            const tt = el('text', { x: gutterX, y: my + padL * 0.024, class: 'mapa-vlabel' }, g);
            tt.setAttribute('font-size', padL * 0.11);
            tt.textContent = valle.replace(' / Leyda', '').replace(' / Región Austral', ' Austral');
          });
        });
